...
String a = WebUI.getText(findTestObject('APOLLO- Desktop/Cart flyout/Unit price - first product'))
...
String b = WebUI.getText(findTestObject('APOLLO- Desktop/Cart flyout/Unit price - second product'))
...
String c = WebUI.getText(findTestObject('APOLLO- Desktop/Cart flyout/Subtotal in cart flyout'))
