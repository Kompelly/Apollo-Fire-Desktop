...
WebUI.click(findTestObject('APOLLO- Desktop/Burger Menu/lamb'))
...
WebUI.click(findTestObject('APOLLO- Desktop/Burger Menu/Burger menu - Shop All'))
...
WebUI.click(findTestObject('APOLLO- Desktop/Burger Menu/collections'))
...
WebUI.click(findTestObject('APOLLO- Desktop/Burger Menu/About'))
...
WebUI.click(findTestObject('APOLLO- Desktop/Burger Menu/Blog'))
...
WebUI.click(findTestObject('APOLLO- Desktop/Burger Menu/Contact us'))
